...
# INTENT_CONF_THRESHOLD = float(os.environ.get("INTENT_CONF_THRESHOLD", 0.60))
...
#     intent_examples = {
#         "greeting": ["hi", "hello", "hey", "hiya", "good morning", "good evening"],
#         "how_are_you": ["how are you", "how are you doing", "what's up", "how's it going"],
...
#     # Try enhancing fallback snippet as well
...
EMBEDDING_MODEL = os.environ.get("EMBEDDING_MODEL", "all-MiniLM-L6-v2")
TOP_K_DEFAULT = int(os.environ.get("TOP_K_DEFAULT", 3))
# Lowered threshold so small chat intents are more likely detected
...
def chat():
    ...
    # 1) predict intent (ML)
    intent, conf = predict_intent(q)
    # debug logging to help verify classifier behavior
